	...
	content: [
		...
		},
		{
			paragraph: {
				phraseToLink: '',
				link: '',
				text: 'In addition to physical evidence, Hancock also looks to ancient myths and legends for clues about this event. He argues that stories passed down through generations in cultures around the world contain references to a catastrophic event that occurred 12,000 years ago. These stories often depict a great flood, fire, or other natural disaster that wiped out the majority of humanity.',
			},
			link: { text: '', type: 'external', link: '' },
		},
		{
