	...
	content: [
		...
		},
		{
			paragraph: {
				phraseToLink: '',
				link: '/',
				text: 'Some researchers propose that the Great Flood legends might have their origin in the Black Sea deluge theory, which suggest that a massive flood occurred in the Black Sea around 7,500 years ago, as a result of the breaching of the Bosporus Strait and the flooding of the Black Sea basin by Mediterranean water.',
			},
			link: { text: '', type: 'external', link: '' },
		},
		{
